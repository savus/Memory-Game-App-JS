...
const fetchData: TApiObject["fetchData"] = async (endpoint) => {
...
const fetchAllPokemon: TApiObject["fetchAllPokemon"] = (
  array,
  arrayToStore,
) => {
...
const buildDummyData: TApiObject["buildDummyData"] = (endpoint) => {
...
const convertToTSObject: TApiObject["convertToTSObject"] = (data) => {
  return {
    name: data.name,
