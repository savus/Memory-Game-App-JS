TASK(completed): Card HTML elements are generated and then appended to the DOM. A strategy is required to allow those elements to be accessed after they've been generated.
...
TASK (completed): relearn and create an async function that pauses the function processes for a specified moment of time
